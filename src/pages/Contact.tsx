          ...
          <div className="contact-content-container">
            ...
            <div className="contact-info-grid">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                whileHover={{ y: -10, boxShadow: "0 20px 40px rgba(94, 196, 232, 0.3)" }} whileTap={{ y: -10, boxShadow: "0 20px 40px rgba(94, 196, 232, 0.3)" }}
                className="info-card email-card"
              >
                <motion.div
                  whileHover={{ scale: 1.1, rotate: 360 }} whileTap={{ scale: 1.1, rotate: 360 }}
                  transition={{ duration: 0.6 }}
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                whileHover={{ y: -10, boxShadow: "0 20px 40px rgba(59, 130, 246, 0.3)" }} whileTap={{ y: -10, boxShadow: "0 20px 40px rgba(59, 130, 246, 0.3)" }}
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                whileHover={{ y: -10, boxShadow: "0 20px 40px rgba(16, 185, 129, 0.3)" }} whileTap={{ y: -10, boxShadow: "0 20px 40px rgba(16, 185, 129, 0.3)" }}
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                whileHover={{ y: -10, boxShadow: "0 20px 40px rgba(139, 92, 246, 0.3)" }} whileTap={{ y: -10, boxShadow: "0 20px 40px rgba(139, 92, 246, 0.3)" }}
                className="info-card direction-card"
              >
                <motion.div
                  whileHover={{ scale: 1.1, rotate: 360 }} whileTap={{ scale: 1.1, rotate: 360 }}
                  transition={{ duration: 0.6 }}
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                whileHover={{ y: -10, boxShadow: "0 20px 40px rgba(236, 72, 153, 0.3)" }} whileTap={{ y: -10, boxShadow: "0 20px 40px rgba(236, 72, 153, 0.3)" }}
              ...
              <div className="contact-form-wrapper">
                ...
                <form className="contact-form" onSubmit={handleSubmit}>
                  <div className="form-row">
                    <motion.div
                      whileHover={{ scale: 1.02 }} whileTap={{ scale: 1.02 }}
